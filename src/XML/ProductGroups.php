...
use HearConcept\HIMSA\XML\Families\{ALDFamily,
    CONFamily,
    FEFamily,
    GCFamily,
    HAAFamily,
 ...
 * @property-read Collection|SUPFamily[] $EarImpressionSupplies Ear impression supplies included in this product catalog. Returns a collection of families.
